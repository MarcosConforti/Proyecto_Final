...
public class Nivel_Cuatro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel__cuatro);
    ...
    public void NumAleatorio(){
        if(score <= 39){
            ...
            numAleatorio_dos = (int) (Math.random() * 10);
              ...
              if(signoAleatorio == 0 || signoAleatorio == 2){
                  resultado = numAleatorio_uno + numAleatorio_dos;
              }else if(signoAleatorio == 1 || signoAleatorio == 3) {
                  resultado = numAleatorio_uno - numAleatorio_dos;
              }
            ...
            Intent intent = new Intent(this, Nivel_Cinco.class);
